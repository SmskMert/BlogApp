...
{
    [DbContext(typeof(BlogApp_Context))]
    [Migration("20221219121734_HasDataInitial")]
    partial class HasDataInitial
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogApplication.Entity.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CategoryUrl = "information-technology",
                            CreatedOn = new DateTime(2022, 12, 19, 15, 17, 34, 161, DateTimeKind.Local).AddTicks(3041),
                            IsPublished = false,
                        ...
                        new
                        {
                            Id = 2,
                            CategoryUrl = "art",
                            CreatedOn = new DateTime(2022, 12, 19, 15, 17, 34, 161, DateTimeKind.Local).AddTicks(3043),
                            IsPublished = false,
                            LastModifiedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PublishedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Title = "Art"
                        ...
                        {
                            Id = 3,
                            CategoryUrl = "life-style",
                            CreatedOn = new DateTime(2022, 12, 19, 15, 17, 34, 161, DateTimeKind.Local).AddTicks(3044),
                            IsPublished = false,
                            LastModifiedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PublishedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Title = "Life Style"
            ...
            modelBuilder.Entity("BlogApplication.Entity.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlogApplication.Entity.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlogApplication.Entity.PostCategory", b =>
                {
                    b.Property<int>("PostId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlogApplication.Entity.PostTag", b =>
                {
                    b.Property<int>("PostId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlogApplication.Entity.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2022, 12, 19, 15, 17, 34, 161, DateTimeKind.Local).AddTicks(2869),
                            IsPublished = false,
                            LastModifiedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PublishedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            TagUrl = "javascript",
                        ...
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2022, 12, 19, 15, 17, 34, 161, DateTimeKind.Local).AddTicks(2882),
                            IsPublished = false,
                            LastModifiedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PublishedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            TagUrl = "web-development",
                            Title = "Web Development"
                        },
                        new
                        {
                            Id = 3,
                            CreatedOn = new DateTime(2022, 12, 19, 15, 17, 34, 161, DateTimeKind.Local).AddTicks(2884),
                            IsPublished = false,
                            LastModifiedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PublishedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            TagUrl = "programming",
                        ...
                        {
                            Id = 4,
                            CreatedOn = new DateTime(2022, 12, 19, 15, 17, 34, 161, DateTimeKind.Local).AddTicks(2885),
                            IsPublished = false,
                            LastModifiedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PublishedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            TagUrl = "self-improvement",
                            Title = "Self Improvement"
                        },
                        new
                        {
                            Id = 5,
                            CreatedOn = new DateTime(2022, 12, 19, 15, 17, 34, 161, DateTimeKind.Local).AddTicks(2886),
                            IsPublished = false,
                            LastModifiedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PublishedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            TagUrl = "architecuture",
                            Title = "Architecture"
                        });
                });
            ...
            modelBuilder.Entity("BlogApplication.Entity.Comment", b =>
                {
                    b.HasOne("BlogApplication.Entity.Post", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("BlogApplication.Entity.PostCategory", b =>
                {
                    b.HasOne("BlogApplication.Entity.Category", "Category")
            ...
            modelBuilder.Entity("BlogApplication.Entity.PostTag", b =>
                {
                    ...
                    b.HasOne("BlogApplication.Entity.Tag", "Tag")
                        .WithMany("PostTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
